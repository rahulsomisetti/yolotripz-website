...
export function StudyAbroadProcess() {
  return (
    <Section
      ...
      title="A clear five-step process — so nobody is guessing the next move."
      description="The same sequence we use for September and January intakes — adjusted to your pace, never to confusion."
    >
        ...
        {processSteps.map((s, i) => (
          <Reveal key={s.step} delay={i * 0.05}>
            <Card className="h-full border border-navy/[0.07] bg-card p-7 shadow-ring md:p-8">
              ...
              <h3 className="mt-6 font-display text-base font-semibold text-navy">{s.title}</h3>
      ...
      <Reveal className="mt-16 text-center md:mt-20" delay={0.12}>
        <div className="mx-auto max-w-3xl border border-navy/[0.08] bg-background px-8 py-10 md:px-12 md:py-12">
          <p className="mx-auto max-w-measure text-pretty text-sm leading-[1.7] text-muted-foreground md:text-[0.9375rem]">
            Ready to map this to your intake year? Send your CV or transcript summary on WhatsApp —
            we will tell you if a counselling call is the right next step.
          </p>
